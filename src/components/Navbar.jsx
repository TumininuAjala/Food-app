    ...
    >
      ...
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Tumi's <span className="font-bold">Bistro</span>
        </h1>
        <div
          className="hidden lg:flex items-center bg-gray-200 rounded-full
         p-2 text-[14px]"
        >
          <p
      ...
      md:flex items-center py-2 rounded-full w-[100px]"
      >
